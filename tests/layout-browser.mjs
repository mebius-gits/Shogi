...
try {
  ...
  await page.screenshot({ path: "preview/redesign-settings.png" });
  ...
  await page.screenshot({ path: "preview/redesign-mobile.png", fullPage: true });
  ...
  await page.screenshot({
    path: "preview/redesign-home-mobile.png",
    fullPage: true,
  });
  ...
  await page.screenshot({ path: "preview/redesign-night.png" });
  ...
  await page.mouse.up();
  const after = await canvas.screenshot({ path: "preview/camera-after.png" });
  ...
  await page.screenshot({ path: "preview/redesign-opponent-hand.png" });
  await expect(page.locator("#board-canvas")).toHaveAttribute(
    "data-phase",
    "idle",
    { timeout: 10000 },
